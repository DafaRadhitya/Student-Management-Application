...
public class session extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(session.class.getName());
    ...
    public session() {
        ...
        tblmapel.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedRow != -1) {
                    ...
                    int modelRow = tblmapel.convertRowIndexToModel(selectedRow);

                    // ⬇ SIMPAN ID KE VARIABEL GLOBAL
                    selectedid = Integer.parseInt(
                        tblmapel.getModel().getValueAt(modelRow, 0).toString()
                    );

                    txtnamamapel.setText(
                        tblmapel.getModel().getValueAt(modelRow, 1).toString()
                    );
                }
            }
        });
    ...
    private boolean tampiltabel() {
        String sql = "SELECT ID, Nama_Mapel FROM mapel";
          try {
              ...
              rs.last();
              if (rs.getRow() == 0){
                  JOptionPane.showMessageDialog(null, "data mapel tidak ada");
              } else {
                  rs.beforeFirst();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(30, 30, 30)
                            .addComponent(txtnamamapel, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        ...
        String namamapel = txtnamamapel.getText().trim();
        ...
        try {
            ...
            if (hasil > 0){
                JOptionPane.showMessageDialog(this, "data mapel berhasil ditambah");
                
                txtnamamapel.setText("");
                tampiltabel();
            } else{
                JOptionPane.showMessageDialog(this, 
                        "gagal menambahkan data mapel");
            }
        } catch (SQLException ex){
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        if (selectedid == 0) {
            JOptionPane.showMessageDialog(this, "Pilih data mapel dari tabel terlebih dahulu!");
            return;
        }
        
        String sql = "UPDATE mapel SET Nama_Mapel = ? WHERE ID = ?";
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1, namamapel);
            ...
            int hasil = ps.executeUpdate();
            if (hasil > 0){
                JOptionPane.showConfirmDialog(this, "data mapel berhasil diubah");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new session().setVisible(true));
    }
